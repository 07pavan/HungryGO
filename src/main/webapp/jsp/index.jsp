    ...
    <section class="py-5 bg-white" id="categories-section">
        <div class="container">
            ...
            <div class="d-flex gap-4 overflow-auto pb-3 scrollbar-hidden" id="categories-container" style="scroll-behavior: smooth;">
                ...
                <a href="${pageContext.request.contextPath}/restaurants?category=North%20Indian" class="category-item text-decoration-none text-dark flex-shrink-0" id="cat-north-indian">
