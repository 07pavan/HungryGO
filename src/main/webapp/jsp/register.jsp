...
<head>
    ...
    <meta name="description" content="Create a free HungryGO account and order food from top restaurants near you.">
            ...
            <div class="card auth-card shadow-lg border-0 p-4" id="register-card">
                <div class="card-body">
                    <div class="d-flex justify-content-center mb-3">
                        <div class="bg-orange text-white d-flex align-items-center justify-content-center rounded-3 bg-orange"
                             style="width: 44px; height: 44px;">
                            <i class="bi bi-person-plus-fill fs-5"></i>
                        </div>
                    </div>

                    <h1 class="h3 text-center fw-bold text-dark mb-1 font-display">Create Account</h1>
                    <p class="text-center text-muted small mb-4">Join HungryGO for high-speed gourmet delivery services</p>

                    <%-- Error set by RegisterServlet.doPost() via requestScope --%>
                    <c:if test="${not empty requestScope.error}">
                        <div class="alert alert-danger px-3 py-2 small rounded-3 d-flex align-items-center gap-2 mb-3"
                    ...
                    <%-- Form → POST /register → RegisterServlet.doPost() --%>
                    <form action="${pageContext.request.contextPath}/register" method="POST"
                          id="register-form" onsubmit="return validateForm()">

                        <div class="form-floating mb-3">
                            <input type="text" name="name" class="form-control rounded-3"
                                   id="register-name-input" placeholder="John Doe"
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" name="email" class="form-control rounded-3"
                                   id="register-email-input" placeholder="name@example.com"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="tel" name="phone" class="form-control rounded-3"
                                           id="register-phone-input" placeholder="+91 99999 99999"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="text" name="pincode" class="form-control rounded-3"
                                           id="register-pincode-input" placeholder="400001"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="address" class="form-control rounded-3"
                                   id="register-address-input" placeholder="123 Main St, Mumbai"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="password" name="password" class="form-control rounded-3"
                                           id="register-password-input" placeholder="Password"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="password" name="confirmPassword" class="form-control rounded-3"
                                           id="register-confirm-input" placeholder="Confirm Password"
                                           required autocomplete="new-password">
                        ...
                        <div class="form-check mb-4 fs-7">
                            <input class="form-check-input accent-orange" type="checkbox"
                                   id="register-agree-check" required>
                            <label class="form-check-label text-muted" for="register-agree-check">
                                I agree to HungryGO's
                                <a href="#" class="text-orange text-decoration-none fw-semibold">Terms of Use</a>
                                &amp;
                                <a href="#" class="text-orange text-decoration-none fw-semibold">Privacy Policy</a>
                            </label>
                        </div>

                        <button type="submit" class="btn btn-orange w-100 py-3 rounded-3 fw-bold fs-6 mb-3 shadow-sm hover-up" id="register-submit-btn">
                    ...
                    <p class="text-center fs-7 text-muted mb-0">
                        ...
                        <a href="${pageContext.request.contextPath}/login" class="text-orange text-decoration-none fw-bold">Sign In Here</a>
                    </p>
                </div>
            </div>
        </div>
